...
extension DatesInfo {
    ...
    [
        DatesInfo(title: "Mary's Birthday", date: (try! Date("Apr 04, 2023", strategy: expectedFormat)), reccuring: true, theme: Color("Blue"), ideas: ["Chocolate", "Crochet"]),
        DatesInfo(title: "Christmas", date: (try! Date("Dec 25, 2023", strategy: expectedFormat)), reccuring: true, theme: Color("Pink"), ideas: ["Jen: Bowl"]),
        DatesInfo(title: "Connor's Birthday", date: (try! Date("Oct 04, 2023", strategy: expectedFormat)), reccuring: true, theme: Color("Green"), ideas: ["Hot Wheels"]),
        DatesInfo(title: "Present swap", date: (try! Date("May 13, 2023", strategy: expectedFormat)), reccuring: false, theme: Color("Yellow"), ideas: ["Trix: flowers","George: Steven Rhodes poster"])
    ]
}
